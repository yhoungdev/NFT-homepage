...
function Ghost() {
  ...
  return (
    ...
    <Box background={'pink.200'} padding={'9em 0'} position='relative' data-aos='fade-up' backgroundImage={'https://res.cloudinary.com/dhkccnvyn/image/upload/v1653478854/samples/bg_ueyolu.svg'} backgroundSize='cover' backgroundRepeat={'no-repeat'}>
      ...
      <Box position={'absolute'} bottom='-20' className='move' overflowX={'hidden'}>
