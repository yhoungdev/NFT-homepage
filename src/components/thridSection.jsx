...
<Box background={'purple.600'} height='100vh' padding={'9em 0'}>
      <div className="container ">
       <Flex display={'flex'} justifyContent='center' alignContent={'center'} >
         
          <Box padding={'2em 2em'} position='relative' borderRadius='1.5em' border={'5px solid black'} width={['100%','40vw']} background='whitesmoke' >
